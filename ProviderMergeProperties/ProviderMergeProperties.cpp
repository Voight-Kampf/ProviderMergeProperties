/*
 *  Copyright © 1998-2017 Apple Inc. All rights reserved.
 *
 ...
 *
 *  IOHIDProviderPropertyMerger.cpp from IOHIDFamily-1035.1.4 © 1998-2014 Apple Inc.
 *
 *  Modified by vulgo 2017
 */

#include <AssertMacros.h>
#include <IOKit/IOLib.h>
#include "ProviderMergeProperties.hpp"

// This required macro defines the class's constructors, destructors,
// and several other methods I/O Kit requires.
//
OSDefineMetaClassAndStructors(ProviderMergeProperties, IOService)

// Define the driver's superclass.
#define super IOService

IOService *ProviderMergeProperties::probe(IOService *provider, SInt32 *score)
{
    OSDictionary *properties = (OSDictionary*)getProperty("IOProviderMergeProperties");
    if (properties) {
        mergeProperties(provider, properties);
    }
    
    // Always fail the probe
    return NULL;
}

bool ProviderMergeProperties::mergeProperties(IOService *provider, OSDictionary *properties)
{
...
bool ProviderMergeProperties::mergeDictionaries(OSDictionary *source, OSDictionary *target)
{
